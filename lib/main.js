...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      `);
            ...
            var conditions = ["assign to me", "please assign me this", "assign this to me"];
            
            if (conditions.some(el => body.toLowerCase().includes(el))){
                yield addAssigneesToAssignable(client, userId, issueNodeId);
            }

//             if (body.toLowerCase().includes("assign to me")) {
//                 yield addAssigneesToAssignable(client, userId, issueNodeId);
//             }
