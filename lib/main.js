...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const commentsEnabled = core.getInput('WITH_COMMENTS', {
                required: true
            });
      ...
      `);
            ...
            console.log(`assigning userId ${userId} to issue #${issueNodeId}`);
...
function getIssueInfo() {
    ...
    const userid = github.context.payload.comment.user.login;
    if (!issue) {
        return;
    }
    return {
